...
(function() {
    const locale = {
        ...
        projects: {
            ...
            featured: 'Featured',
            featuredSubtitle: 'Start here. These picks best represent the direction and quality of the current project set.',
            featuredBadge: 'JS PICK',
            allProjects: 'All Projects',
            catalogSubtitle: 'This is the full catalog. Browse by category or search directly.',
            allCategories: 'ALL',
        ...
        // Gallery
        gallery: {
            pageTitle: 'Gallery - JS ClawHub',
            metaDesc: 'AI Art Gallery — each image includes full prompts, workflow & model info',
            heroDesc: 'AI art collection — every piece comes with full <span class="bg-black text-brand-yellow px-1">creation params</span>, ready to reproduce.',
            searchPlaceholder: 'Search artworks...',
            loading: 'LOADING...',
            noItems: '// NO ARTWORKS YET',
            noItemsDesc: 'Artworks are coming soon. Stay tuned.',
            ...
            loadingDetail: 'LOADING...',
            itemNotFound: '// ARTWORK NOT FOUND',
            browseAll: 'BROWSE ALL ARTWORKS',
            ...
            copy: 'COPY',
            copyAll: 'COPY ALL PARAMS',
            shareLink: 'SHARE LINK',
            copied: 'Copied!',
            detailTitleSuffix: ' - JS ClawHub Gallery',
            tags: {},
        },
